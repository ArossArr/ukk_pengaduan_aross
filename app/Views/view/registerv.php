                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="/sregister" method="post">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="tlp" id="tlp"
                                        placeholder="No.Tlp">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <button type="submit" class="btn btn-primary form-control">Register Account!</button>
                            </form>
                            <hr>
                            <div class="text-center">
